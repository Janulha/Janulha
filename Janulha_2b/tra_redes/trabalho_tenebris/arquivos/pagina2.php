...
<head>
    ...
    <title>
        <?php
        if (isset($_SESSION['busca_produto'])) {
            echo 'Exibindo resultados para: ' . $_SESSION['busca_produto'];
        } else {
            echo "Tenebris";
        }
        ?>
...
<body id="segundo">
    ...
    <div id="loja" class="container-fluid">
        <div id="produto1" class="container-fluid">
            <div id="foto1" class="container-fluid"><a id="prod" href="pagina4.html">Página 4</a></div>
            <div id="nome1" class="container-fluid"></div>
            <div id="descricao1" class="container-fluid"></div>
            <div id="valor1" class="container-fluid"></div>
        ...
        <div id="produto2" class="container-fluid">
            <div id="foto2" class="container-fluid"><a id="prod" href="pagina4.html">Página 4</a></div>
        ...
        <div id="produto3" class="container-fluid">
            <div id="foto3" class="container-fluid"><a id="prod" href="pagina4.html">Página 4</a></div>
