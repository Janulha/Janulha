    ...
    <body id="primeiro">
        <div id="menu" class="container-fluid">
            <div class="container-child">
                <a href="pagina.html">
                    <img id="logo" src="../personalizacao/IMAGENS/Logo.png" alt="Sorry!">
                </a>
            </div>
            <div class="container-child">
                <a href="pagina.html">
                    <img id="nome" src="imagens/Nome.png" alt="Sorry!">
                </a>
            </div>
            ...
            <div class="container-fluid">
                <div id="selecao" class="card">
                    <ul class="list-group list-group-flush">
                        <li id="selecao2" class="list-group-item"><h3><b>Seleção</b></h3></li>
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    <div>
                                        <div class="preco">
                                            <input type="radio" id="preco1" name="preco" value="preco1">
                                                <label for="preco1">Menor que R$2.000,00</label><br>
                                            <input type="radio" id="preco2" name="preco" value="preco2">
                                                <label for="preco2">De R$2.000,00 à R$5.000,00</label><br>
                                            <input type="radio" id="preco3" name="preco" value="preco3">
                                                <label for="preco3">De R$5.000,00 à R$10.000,00</label><br>
                                            <input type="radio" id="preco4" name="preco" value="preco4">
                                                <label for="preco4">Sem limite de preço.</label><br><br>        
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="rodape" class="container-fluid">
                <div class="container-fluid">
                    <a href="#">
                        <svg id="x" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
